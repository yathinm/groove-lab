...
export function FileUpload({ disabled, processing, error, onSelect }: Props) {
  return (
    <section className="flex flex-col gap-3">
      ...
      <div className="group flex items-center justify-between rounded-xl border-2 border-dashed border-slate-600 bg-slate-800/40 px-4 py-6 transition-colors hover:bg-slate-800/60">
        <div className="flex items-center gap-2 text-sm text-slate-300">
          <Upload className="h-4 w-4" /> Drag & drop your file here, or choose a file
        </div>
